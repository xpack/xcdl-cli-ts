...
The configuration header files end up in a folder in the build tree, usually `install`. It is up to the component writers how many files are generated, and how definition are split between components.
