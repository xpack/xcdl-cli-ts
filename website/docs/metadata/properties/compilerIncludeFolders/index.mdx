...
The `compilerIncludeFolders` property is an array of strings that specify folder paths relative to the current xCDL file. These folders contain header files to be utilized during the build process.
