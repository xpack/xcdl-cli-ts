...
title: xCDL compilerSourceFiles
...
List the source files that should be compiled if this object is active and enabled.
...
The value of the `compilerSourceFiles` property is an array of relative paths to files containing source code to be included in the build.
