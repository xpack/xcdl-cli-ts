...
export default function func({objectType = 'TYPE'}) {
  return (
    <>
      <MetadataObjectPropertyLink name='customDefine' /> - a valid C/C++ preprocessor identifier to be defined in the header file if the {objectType} is active and enabled
    </>
  )
}
