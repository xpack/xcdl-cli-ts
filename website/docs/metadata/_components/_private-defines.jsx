...
export default function func({objectType = 'TYPE'}) {
  return (
    <>
      <MetadataObjectPropertyLink name='privateDefines' /> - a map of toolchain-specific objects with preprocessor macros used during the build if this {objectType} is active and enabled
    </>
  )
}
