...
export default function func({objectType = 'TYPE'}) {
  return (
    <>
      <MetadataObjectPropertyLink name='privateCompilerOptions' /> - a map of toolchain-specific objects with compiler private options used during the build if this {objectType} is active and enabled
    </>
  )
}
