...
# How to get help for xcdl

## Quick links

The quick answer is to use the
[GitHub Discussions](https://github.com/xpack/xcdl-cli-ts/discussions)
pages.
...
- Check the [GitHub Discussions](https://github.com/xpack/xcdl-cli-ts/discussions) for
similar topics
- Check the [GitHub Issues](https://github.com/xpack/xcdl-cli-ts/issues)
tracker and the
[GitHub Pull Requests](https://github.com/xpack/xcdl-cli-ts/pulls)
for similar problems.
...
others, please 
use the [GitHub Discussions](https://github.com/xpack/xcdl-cli-ts/discussions)
pages.
...
[GitHub Issues](https://github.com/xpack/xcdl-cli-ts/issues)
tracker.
...
[GitHub Discussions](https://github.com/xpack/xcdl-cli-ts/discussions)** pages.
