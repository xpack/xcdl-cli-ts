...
[xcdl](https://www.npmjs.com/package/xcdl) is a npm package available
...
- **Star** the project on [GitHub](https://github.com/xpack/xcdl-cli-ts/): It helps others discover our work.
