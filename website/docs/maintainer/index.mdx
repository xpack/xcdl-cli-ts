...
[![CI on Push](https://github.com/xpack/xcdl-cli-ts/actions/workflows/test-ci.yml/badge)](https://github.com/xpack/xcdl-cli-ts/actions/workflows/test-ci.yml)
...
In the `xpack/xcdl-cli-ts` Git repo:
...
- determine the next version (like <code>2.0.0</code>)
- update the version in the top `package.json` file
- use the new version, suffixed by `-pre`, like <code>2.0.0-pre</code>.
...
- https://github.com/xpack/xcdl-cli-ts/issues
- https://github.com/xpack/xcdl-cli-ts/pulls

and fix them; assign them to a milestone
(like <code>2.0.0</code>).
...
- add a new entry like _**\* v2.0.0 prepared**_
- commit with a message like _**prepare v2.0.0**_
...
- check https://github.com/xpack/xcdl-cli-ts/actions
...
- commit with _**website: blog post release 2.0.0 published**_
...
[xcdl Versions](https://www.npmjs.com/package/xcdl?activeTab=versions).
...
```bash
npm install ----location=global xcdl@next
```
...
[GitHub Pages](https://xpack.github.io/xcdl/).
...
[GitHub Actions](https://github.com/xpack/xcdl-cli-ts/actions/workflows/publish-github-pages.yml).
...
in https://xpack.github.io/xcdl/blog/
...
Check the result at https://xpack.github.io/xcdl/.
...
In https://github.com/xpack/xcdl-cli-ts/milestones:
...
<CodeBlock language="sh"> {
`npm dist-tag add xcdl@2.0.0 latest
npm dist-tag ls xcdl
`} </CodeBlock>
...
- npmjs.com [`xcdl`](https://www.npmjs.com/package/xcdl/) package
  - latest release, per month
[![npm (scoped)](https://img.shields.io/npm/v/xcdl)](https://www.npmjs.com/package/xcdl/)
[![npm](https://img.shields.io/npm/dm/xcdl)](https://www.npmjs.com/package/xcdl/)
  - all releases [![npm](https://img.shields.io/npm/dt/xcdl)](https://www.npmjs.com/package/xcdl/)
