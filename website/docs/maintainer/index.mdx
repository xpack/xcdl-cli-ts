...
[![GitHub package.json version](https://img.shields.io/github/package-json/v/xpack/xcdl-cli-ts?color=green)](https://github.com/xpack/xcdl-cli-ts/blob/mater/package.json)
...
```sh
npm --prefix ~/Work/npm-packages/xcdl-cli-ts.git/website run clean
npm --prefix ~/Work/npm-packages/xcdl-cli-ts.git/website run start
```
...
```sh
npm --prefix ~/Work/npm-packages/xcdl-cli-ts.git/website run generate-website-blog-post
```
...
```sh
npm --prefix ~/Work/npm-packages/xcdl-cli-ts.git/website run build
```
...
[GitHub Pages](https://xpack.github.io/xcdl-cli-ts).
...
in https://xpack.github.io/xcdl-cli-ts/blog/
...
- <code>npm dist-tag add xcdl@{customField('releaseVersion')} latest</code>
- `npm dist-tag ls xcdl`
